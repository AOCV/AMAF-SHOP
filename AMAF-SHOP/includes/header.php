...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="index.php">AMAF-SHOP</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link cart-icon-container" href="panier.php">
                            <i class="fas fa-shopping-cart"></i>
                            <?php if (getNombreArticlesPanier() > 0): ?>
                            <span class="cart-count"><?= getNombreArticlesPanier() ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
